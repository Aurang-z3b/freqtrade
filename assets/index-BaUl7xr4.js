...
`,et={root:"p-chip p-component",image:"p-chip-image",icon:"p-chip-icon",label:"p-chip-label",removeIcon:"p-chip-remove-icon"},tt=ne.extend({name:"chip",style:Xe,classes:et}),it={name:"BaseChip",extends:ge,props:{label:{type:[String,Number],default:null},icon:{type:String,default:null},image:{type:String,default:null},removable:{type:Boolean,default:!1},removeIcon:{type:String,default:void 0}},style:tt,provide:function(){return{$pcChip:this,$parentInstance:this}}},oe={name:"Chip",extends:it,inheritAttrs:!1,emits:["remove"],data:function(){return{visible:!0}},methods:{onKeydown:function(t){(t.key==="Enter"||t.key==="Backspace")&&this.close(t)},close:function(t){this.visible=!1,this.$emit("remove",t)}},computed:{dataP:function(){return E({removable:this.removable})}},components:{TimesCircleIcon:me}},nt=["aria-label","data-p"],lt=["src"];function ot(e,t,i,l,o,n){return o.visible?(a(),r("div",s({key:0,class:e.cx("root"),"aria-label":e.label},e.ptmi("root"),{"data-p":n.dataP}),[p(e.$slots,"default",{},function(){return[e.image?(a(),r("img",s({key:0,src:e.image},e.ptm("image"),{class:e.cx("image")}),null,16,lt)):e.$slots.icon?(a(),v(C(e.$slots.icon),s({key:1,class:e.cx("icon")},e.ptm("icon")),null,16,["class"])):e.icon?(a(),r("span",s({key:2,class:[e.cx("icon"),e.icon]},e.ptm("icon")),null,16)):h("",!0),e.label?(a(),r("div",s({key:3,class:e.cx("label")},e.ptm("label")),I(e.label),17)):h("",!0)]}),e.removable?p(e.$slots,"removeicon",{key:0,removeCallback:n.close,keydownCallback:n.onKeydown},function(){return[(a(),v(C(e.removeIcon?"span":"TimesCircleIcon"),s({class:[e.cx("removeIcon"),e.removeIcon],onClick:n.close,onKeydown:n.onKeydown},e.ptm("removeIcon")),null,16,["class","onClick","onKeydown"]))]}):h("",!0)],16,nt)):h("",!0)}oe.render=ot;var st=ie`
    .p-multiselect {
        display: inline-flex;
        cursor: pointer;
        position: relative;
